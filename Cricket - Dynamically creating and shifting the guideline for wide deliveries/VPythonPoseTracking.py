...
# cap = cv2.VideoCapture(r'Datasets\Batsman Movement Dataset\batsmanOnWideL1.MOV')
cap = cv2.VideoCapture(r'Datasets\Batsman Movement Dataset\batsmanOnWideL2.MOV')
# cap = cv2.VideoCapture(r'Datasets\Batsman Movement Dataset\batsmanOnWideR1.MOV')
# cap = cv2.VideoCapture(r'Datasets\Batsman Movement Dataset\batsmanOnOutsideL.MOV')
# cap = cv2.VideoCapture(r'Datasets\Batsman Movement Dataset\batsmanOnOutsideR.MOV')
# cap = cv2.VideoCapture(r'Datasets\Batsman Movement Dataset\batsmanStanding.MOV')
